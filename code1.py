...
async def botinfo(ctx):
    ...
    embed.set_thumbnail(thumbnail_url=f'{author.avatar_url}')
    embed.set_footer(text=f'Requested by {ctx.message.author.name}', icon_url=f'{ctx.message.author.avatar_url}')
    embed.timestamp = datetime.datetime.utcnow()
    ...
    embed.add_field(name="__**Servers**__", value=str(len(client.guilds)), inline = True)
    embed.add_field(name="__**Users**__", value=str(len(set(client.get_all_members()))), inline = True)

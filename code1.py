...
async def help(ctx):
    ...
    embed.add_field(name="__**administrator commands**__", value="`serverinfo` - This will show the server's information (Administrator). \n`membercount` - This will show how many servers mamber in. \n`poll` - Polling (Administrator). \n`ban` - this will ban the user. \n`clear` - will clear messages(Administrator). \n`announce` - To announce the entered **#channel** n **matter** (Administrator). ", inline=True)

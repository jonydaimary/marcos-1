...
async def membership(ctx):
    rule_1 = "Benefits \n:tick: 25% off in <#609196821071527956> \n\n:tick: Snipe freely in channels \n\n:tick: Receive 3 invites Free in each invite contest \n\n:tick: Get access to custom chat room where are you can invite your friends \n\n:tick: Membership includes all passes including the ones we add in future at no extra cost to you \n\nCost- \n:moneybag: 100,000 credits for lifetimes \n\n:moneybag: 20,000 credits for 1 month \n\n:moneybag: 10,000 credits for 1 weekly"
